...
const steps = [
  ...
  },
  {
    ...
    description: 'Share your creations with your audience using our easy-to-use tools.',
  },
  {
    title: 'Set Up Subscriptions',
    description: 'Choose your subscription tiers and pricing to monetize your content.',
  },
  {
...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" ref={sectionRef} className="py-20 bg-gradient-to-b from-zinc-800 to-zinc-900">
            ...
            >
              <div className="flex items-center">
                <div className="flex items-center justify-center w-12 h-12 bg-zinc-700 rounded-full">
                  <span className="text-xl font-bold text-zinc-100">{index + 1}</span>
                </div>
